...
import com.kb.selenium.clippercard.dataProvider.loginUser.LoginUserInMemoryDataProvider;
 ...
 */
public class LoginTestV5 {
    private static Logger logger = Logger.getLogger(LoginTestV5.class);
    ...
    public Object[][] getLoginTestUsersInMemory() {
        LoginUserDataProvider dataProvider = new LoginUserInMemoryDataProvider();
